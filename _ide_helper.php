...
namespace App\Livewire\Page {
    ...
    class Dashboard {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Page\Dashboard::modal($name);
        }
    ...
    class Faculty {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Page\Faculty::modal($name);
        }
    ...
    class Department {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Page\Department::modal($name);
        }
    ...
    class Subject {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Page\Subject::modal($name);
        }
    ...
    class Schedule {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Page\Schedule::modal($name);
        }
