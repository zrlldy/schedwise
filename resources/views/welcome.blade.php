...
<head>
    ...
    <!-- Styles -->
    <style>
        /*! tailwndcss v4.0.14 | MIT License | https://tailwindcss.com */
        @layer theme {
...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
<nav class="fixed top-0 z-50 bg-white dark:bg-zinc-900 flex items-center justify-end gap-4 p-4 shadow-sm border border-amber-100 rounded-4xl">
    @auth
