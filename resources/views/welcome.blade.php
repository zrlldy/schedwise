...
<body class="w-screen h-screen bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex flex-col items-center justify-center p-5">
        {{-- <nav class="  w-full shadow-sm border rounded-xl p-4 mt-10 bg-red-600"> --}}
            <nav class="fixed top-0 z-50 w-[60%] bg-[#373434] dark:bg-zinc-900 flex items-center justify-end gap-4 p-4 shadow-sm border border-amber-100 rounded-2xl mt-8 text-white">

           
            <div class="flex items-center justify-end gap-3">
                    <h1 class="text-center font-bold mr-40">Schedwise</h1>
                @if (Route::has('login'))
                    @auth
