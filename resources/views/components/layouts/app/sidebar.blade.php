            ...
            <flux:navlist.group :heading="__('Platform')" class="grid">
                <div class="flex flex-col gap-2">
                    ...
                    <flux:navlist.group expandable heading="Department/Subject" class="hidden lg:grid">
                        ...
                        <flux:navlist.item icon="home" :href="route('subject')"
                            :current="request()->routeIs('subject')" wire:navigate>{{ __('Subject') }}
                        </flux:navlist.item>

                        <flux:navlist.item icon="home" :href="route('room')" :current="request()->routeIs('room')"
                            wire:navigate>{{ __('Room') }}</flux:navlist.item>
                    </flux:navlist.group>
